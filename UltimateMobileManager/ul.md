...
### 2. Wireless Connection & Privacy
Connect without cables - fully secure.

1.  **Connect**:
    *   Use **Device** -> **Enable Wi-Fi Mode** (requires USB once).
    *   Then **Device** -> **Wireless Connect**.
2.  **Disconnect (Privacy Mode)**:
    *   Go to **Device** -> **Disconnect Wireless**.
    *   This instantly cuts all wireless connections.
3.  **Auto Cleanup**:
    *   Closing the app automatically disconnects everything.
    *   **Zero Trace**: No background processes are left running.

<br>

### 3. Web Access Dashboard (New! 🌍)
Manage your device from any browser on your network. Now with **Full PC Drive Access**!

1.  **Start Server**:
    *   Go to **Tools** -> **Start Web Access**.
    *   A secure Link and PIN will appear.
2.  **Open Browser**:
    *   Open link on any device.
    *   Enter PIN to Login.
3.  **Features**:
    *   **📱 Mobile Files**: Browse and download files from your phone.
    *   **💻 PC Files**: Access ALL drives (**C:/, D:/, E:/**, etc.) remotely.
    *   **Real-time Stats**: Battery and Device info.
4.  **Privacy**:
    *   **No Tracking**: Data stays on your local Wi-Fi. No internet used.
    *   **Zero Trace**: Using private headers to prevent browser caching.
    *   **Auto-Stop**: Server stops instantly when the app is closed.
