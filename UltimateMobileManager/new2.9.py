...
def print_start_message_animated():
    ...
    messages = [
        (f"    {C.BWHT}[{C.BGRN}OK{C.BWHT}]{C.RST} ", f"{C.BGRN}All systems initialized successfully!{C.RST}"),
        (f"    {C.BWHT}[{C.BGRN}OK{C.BWHT}]{C.RST} ", f"{C.BGRN}Started at: {C.BYEL}{current_time}{C.RST}"),
